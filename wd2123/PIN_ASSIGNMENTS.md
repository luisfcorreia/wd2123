...
The WD2123 operates at 5 V TTL. The STM32F411CE operates at 3.3 V.
All host-driven inputs (D0–D7, CS1, CS2, CS3, C/D, RE, WE, MR, CTS-A, CTS-B)
must be shifted down to 3.3 V. A 74AHCT125 or similar quad buffer/level shifter
is suitable. The STM32 outputs (TXRDY, RXRDY, TXE, RTS, TXD) are 3.3 V and
may need level shifting up to 5 V depending on the host system.
